    ...
    <CssVarsProvider defaultMode="dark" disableTransitionOnChange>
            ...
            <Stack gap={4} sx={{ mt: 2 }}>
              <form>
                ...
                <FormControl required>
                  <FormLabel>Pancard (optional)</FormLabel>
                  <Input
                    type="text"
                    name="pancard"
      ...
      <Box
        sx={(theme) => ({
          ...
          backgroundImage: `url(https://img.freepik.com/free-vector/data-points-concept-illustration_114360-2194.jpg?w=740&t=st=1725530601~exp=1725531201~hmac=57bf673041ec06b1b4fed0bac848c3a15dbea58214e1f93958ba0fa821ea4be3)`,
          [theme.getColorSchemeSelector("dark")]: {
            backgroundImage: `url(https://img.freepik.com/free-vector/data-points-concept-illustration_114360-2194.jpg?w=740&t=st=1725530601~exp=1725531201~hmac=57bf673041ec06b1b4fed0bac848c3a15dbea58214e1f93958ba0fa821ea4be3)`,
          },
        })}
