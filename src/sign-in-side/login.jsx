    ...
    <CssVarsProvider defaultMode="dark" disableTransitionOnChange>
          ...
          >
            <Stack gap={4} sx={{ mb: 2 }}>
              <Stack gap={1}>
                ...
                <Typography level="body-sm">Team Management </Typography>
              </Stack>
            </Stack>
      ...
      <Box
        sx={(theme) => ({
          ...
          backgroundImage: `url(https://img.freepik.com/free-vector/computer-login-concept-illustration_114360-7962.jpg?t=st=1725537009~exp=1725540609~hmac=58ae8679517c1a7462557751ce0f93c32c46bc239fb10fe6a881aae0b2fe3f01&w=740)`,
